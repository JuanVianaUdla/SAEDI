        ...
        protected void btnRegistrar_Click(object sender, EventArgs e)
        {
                ...
                if (objDatosAsistencia.consultarIngresoDiario(int.Parse(ddlLineaAccion.SelectedValue), int.Parse(ddlOrientador.SelectedValue), int.Parse(ddlProceso.SelectedValue), int.Parse(ddlPeriodo.SelectedValue), DateTime.Parse(ddlFecha.SelectedValue.ToString())))
                {
                    foreach (GridViewRow gvr in grvJovenes.Rows)
                    {
                        ...
                        if (objDatosAsistencia.IngresoDatosAsistenciaDiaria(int.Parse(ddlLineaAccion.SelectedValue), int.Parse(ddlOrientador.SelectedValue), int.Parse(ddlProceso.SelectedValue), int.Parse(ddlPeriodo.SelectedValue), int.Parse(ddlAsisencia.SelectedValue), int.Parse(gvr.Cells[4].Text), DateTime.Parse(ddlFecha.SelectedValue.ToString())))
                        {
