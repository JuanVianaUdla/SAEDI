<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/PrincipalAdministrador.Master" AutoEventWireup="true" CodeBehind="frmManejoObjetivos.aspx.cs" Inherits="Sembrar.Administrador.frmManejoObjetivos" %>
...
<table style="width:100%;" __designer:mapid="192">
    <tr __designer:mapid="1ab">
        <td __designer:mapid="1ac" colspan="3">
            <table id="crearObjetivo" style="width: 100%;">
                <tr>
                    <td class="auto-style1" colspan="3">Crear nuevo Objetivo</td>
                </tr>
                <tr>
                    <td class="auto-style2">Nombre del objetivo:</td>
                    <td>
                        <asp:TextBox ID="txtNombreObjetivo" runat="server"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
