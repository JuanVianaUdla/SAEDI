...
<asp:Button ID="btnIngresar" runat="server" Text="Ingresar" OnClick="btnIngresar_Click" style="height: 29px" />
        ...
        <tr>
            ...
            <td>
                <asp:GridView ID="gvFamilias" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="odsFamilias" ForeColor="Black" Width="100%" GridLines="Horizontal" AllowPaging="True">
