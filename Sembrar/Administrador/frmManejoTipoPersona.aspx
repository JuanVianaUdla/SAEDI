            ...
            <td __designer:mapid="1ac" colspan="3">
                <table id="crearProceso" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNombreTipoPersona" runat="server"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style4">
                            <asp:TextBox ID="txtEdadMinima" runat="server"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtEdadMaxima" runat="server"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
