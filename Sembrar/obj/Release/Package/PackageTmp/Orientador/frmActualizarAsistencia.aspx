<%@ Page Title="" Language="C#" MasterPageFile="~/Orientador/PrincipalOrientador.Master" AutoEventWireup="true" CodeBehind="frmActualizarAsistencia.aspx.cs" Inherits="Sembrar.Orientador.ActualizarAsistencia" %>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="ddlTema" runat="server" AppendDataBoundItems="True" DataTextField="NOMBREORIENTADOR" DataValueField="IDORIENTADOR" Height="16px" OnSelectedIndexChanged="ddlOrientador2_SelectedIndexChanged" Width="166px">
                    <asp:ListItem Selected="True" Value="0">--Seleccione un tema--</asp:ListItem>
                </asp:DropDownList>
            </td>
