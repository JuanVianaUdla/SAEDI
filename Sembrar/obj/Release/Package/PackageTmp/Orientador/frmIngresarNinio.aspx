<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Orientador/PrincipalOrientador.Master" AutoEventWireup="true" CodeBehind="frmIngresarNinio.aspx.cs" Inherits="Sembrar.Orientador.IngresarNiño" %>
        ...
        <tr>
            ...
            <td class="auto-style19" style="text-align: left">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server"
                    ControlToValidate="txtDiscapacidad" ErrorMessage="Este campo acepta solo letras" 
                    ValidationExpression="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" Display="Dynamic"></asp:RegularExpressionValidator>
