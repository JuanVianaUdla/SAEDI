            ...
            <td __designer:mapid="1ac" colspan="3">
                <table id="crearProceso" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNombreLineaAccion" runat="server"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTipoPersona" runat="server" DataSourceID="odsTipoPersona" DataTextField="NOMBRETIPOPERSONA" DataValueField="IDTIPOPERSONA" Width="158px">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDescripcion" runat="server" Height="78px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
