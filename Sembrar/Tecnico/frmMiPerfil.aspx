<%@ Page Title="" Language="C#" MasterPageFile="~/Tecnico/PrincipalTecnico.Master" AutoEventWireup="true" CodeBehind="frmMiPerfil.aspx.cs" Inherits="Sembrar.Tecnico.frmMiPerfil" %>
    ...
    <table __designer:mapid="4c" style="width:100%;">
        ...
        <tr>
            ...
            <td class="auto-style2">
                <asp:HyperLink ID="hlPass" runat="server" NavigateUrl="~/Tecnico/frmCambioPass.aspx">¿Desea cambiar la contraseña?</asp:HyperLink>
            </td>
